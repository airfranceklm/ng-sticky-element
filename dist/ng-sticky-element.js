...
(function (window, angular, undefined) {
  ...
  angular.module('afklStickyElement.directives', []).directive('afklStickyElement', ['$window', '$timeout', function ($window, $timeout) {
    return {
      restrict: 'A',
      link: function link(scope, element, attrs) {
        ...
        function calculateElementPosition() {
          elPos = stickTo === TOP ? $window.pageYOffset + domEl.getBoundingClientRect().top : $window.pageYOffset + domEl.getBoundingClientRect().top + domEl.offsetHeight;
